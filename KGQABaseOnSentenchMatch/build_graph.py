...
代码包含：
加载entity-relation-entity, entity-attribute-value两个文件，并进行数据清洗
两部分数据分别通过循环生成cypher语句，并运行图数据库生成图
将实体，关系，属性，属性值保存至一个单独文件中
'''


# 连接图数据库
graph = Graph("http://localhost:7474", auth=("neo4j", "xxxxx"))
