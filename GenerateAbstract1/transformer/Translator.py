...
from transformer.Models import Transformer, get_subsequent_mask
...
class Translator(nn.Module):
    ...
    def _model_decode(self, trg_seq, trg_position_seq, tag_mask, enc_output, src_mask):
        ...
        dec_output, *_ = self.model.decoder(trg_seq, trg_position_seq, tag_mask, enc_output, src_mask)
    ...
    def _get_init_state(self, src_seq, src_mask, src_position_seq, tag_seq, tag_mask, trg_position_seq):
        ...
        enc_output, *_ = self.model.encoder(src_seq, src_position_seq, src_mask)
    ...
    def translate_sentence(self, src_seq, input_position_seq, tag_seq, tag_position_seq):
        ...
        with torch.no_grad():
            ...
            """
            tag_mask = get_pad_mask(self.init_seq, self.tag_pad_idx) & get_subsequent_mask(self.init_seq)
